...
export default function SignIn() {
  ...
  return (
    <PageShell>
      <PageHeader eyebrow="Welcome back" title={<>Sign in to <span className="text-gradient-blue">DIRHAMPAY</span></>} sub="Your private financial ecosystem awaits." />
      <div className="mx-auto mt-12 max-w-md">
        <GlowCard>
          <form onSubmit={submit} className="space-y-4">
            <Field label="Email" type="email" placeholder="you@dirhampay.com" value={email} onChange={setEmail} required />
          ...
          <GhostButton onClick={() => { setLoading(true); setTimeout(() => { setLoading(false); setOk(true); setTimeout(() => nav("/wallet"), 700); }, 700); }} className="w-full">
          ...
          <SuccessToast show={ok} text="Welcome back. Redirecting to your wallet…" />
